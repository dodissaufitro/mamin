...
const PERMISSION_GROUPS = [
    ...
    { label: 'Dokumen Berlaku', key: 'jenis_dokumen', cruds: ['view', 'create', 'update', 'delete'], icon: FileCheck2, desc: 'Kelola master Dokumen Berlaku' },
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-4 p-4 md:p-6 max-w-5xl mx-auto min-w-0 w-full">
                <AppPageHeader
                    ...
                    description="Buat role baru dan atur hak akses matriksnya"
                    action={
                        <div className="flex items-center gap-2">
                            ...
                            >
                                <Save className="h-4 w-4" /> Simpan Role
                            </button>
                        </div>
                    }
                />
                ...
                <AppContentCard className="p-6 md:p-8 bg-white/40 backdrop-blur-md border border-white/60 shadow-xl shadow-slate-200/40">
                    <form id="role-form" onSubmit={handleSubmit} className="flex flex-col gap-8">
                        <div className="flex flex-col gap-1 w-full md:w-1/2">
                            ...
                            <input
                                type="text"
                                className="rounded-xl border border-slate-200 px-4 py-3 text-sm font-medium outline-none transition-all w-full shadow-sm bg-white/80 focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20"
                                placeholder="Misal: auditor_internal"
                                value={data.name}
