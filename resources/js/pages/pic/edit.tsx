    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="mx-auto max-w-lg p-4 md:p-6">
                <h1 className="mb-6 text-lg font-bold text-violet-800 dark:text-violet-200">Edit PIC</h1>
                <form onSubmit={handleSubmit} className="rounded-xl border border-violet-200 bg-white p-5 shadow-sm dark:bg-sidebar dark:border-violet-800 flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <input type="text" className={inputClass} value={data.jabatan} onChange={e => setData('jabatan', e.target.value)} />
